...
public class Many2ManyAnalyzer extends AssociationsAnalyzer
{
	 ...
	 * {@link DataSupport#addAssociatedModelForJoinTable(String, long)} will be
	 ...
	 *            The baseObj currently want to persist or update.
	 */
	private void addNewModelForAssociatedModel(
			Collection< DataSupport > associatedModelCollection, DataSupport baseObj )
	{
