...
public class BaseUtility
{
			...
			if ( conditionsSize > 0 )
			{
				...
				if ( conditionsSize != placeHolderSize + 1 )
				{
					throw new DataSupportException(
							DataSupportException.UPDATE_CONDITIONS_EXCEPTION );
				}
			}
		}
	}
	...
	public static boolean isFieldTypeSupported( String fieldType )
	{
		...
		else if ( "char".equals( fieldType ) || "java.lang.Character".equals( fieldType ) )
		{
			return true;
		}
		else if ( "java.lang.String".equals( fieldType ) || "java.util.Date".equals( fieldType ) )
		{
			return true;
		}
		return false;
